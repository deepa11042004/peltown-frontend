...
export const SERVICES_CONTENT: Record<string, SectionConfig> = {
  ...
  "seo-optimization": {
    ...
    logoBanner: {
      ...
      tools: [
        { name: "Analytics", img: "/Img/web-dev.png" },
        { name: "Search Console", img: "/Img/app-dev.png" },
        { name: "Ahrefs Premium", img: "/Img/crm-sol.png" },
        { name: "Semrush Suite", img: "/Img/host-server.png" },
        { name: "Google Trends", img: "/Img/seo-market.png" },
        { name: "Screaming Frog", img: "/Img/web-dev.png" },
      ],
    },
    bannerDetail: {
  ...
  "social-media": {
    ...
    logoBanner: {
      ...
      tools: [
        { name: "Meta Business", img: "/Img/web-dev.png" },
        { name: "Instagram Grid", img: "/Img/app-dev.png" },
        { name: "YouTube", img: "/Img/crm-sol.png" },
        { name: "Pinterest", img: "/Img/host-server.png" },
        { name: "Buffer Hub", img: "/Img/seo-market.png" },
        { name: "X (Twitter)", img: "/Img/web-dev.png" },
      ],
    },
    bannerDetail: {
  ...
  "email-solutions": {
    ...
    audience: {
      title: "Our Email Solutions Services",
      desc: "From basic custom domain emails to enterprise suites and migrations, we manage the entire process.",
      list: [
        {
          title: "Business Email Setup",
          desc: "Create professional email addresses using your company domain (e.g. info@, sales@). Includes domain configuration, mailbox creation, device setup, DNS configuration, and email client setup.",
          img: "/Img/crm-sol.png",
        },
        {
          title: "Google Workspace Setup",
          desc: "Empower your team with Google's productivity suite. Includes Gmail Business setup, Google Drive configuration, Google Meet setup, collaboration tools, user management, and security configuration.",
          img: "/Img/host-server.png",
        },
        {
          title: "Microsoft 365 Setup",
          desc: "Enterprise-grade communication and productivity solutions. Includes Outlook Business email, Microsoft Teams, OneDrive, SharePoint, Exchange Online, and user administration.",
          img: "/Img/seo-market.png",
        },
        {
          title: "Email Migration Services",
          desc: "Moving from one email provider to another? We ensure a smooth migration with minimal downtime. Workspace, Microsoft 365, cPanel, Zoho Mail, and Exchange migration including history, contacts, and folders.",
          img: "/Img/web-dev.png",
        },
        {
          title: "Email Security Solutions",
          desc: "Protect business communication from spam, phishing, and cyber threats. Setup SPF, DKIM configuration, DMARC implementation, anti-spam protection, email authentication, and security audits.",
          img: "/Img/app-dev.png",
        },
        {
          title: "Corporate Infrastructure",
          desc: "Advanced email solutions for growing businesses. Multiple departments, shared mailboxes, team mailboxes, distribution lists, email policies, and access controls.",
          img: "/Img/crm-sol.png",
        },
        {
          title: "Custom Email Server Setup",
          desc: "For businesses needing complete control: SMTP configuration, dedicated mail servers, transactional email setup, deliverability optimization, monitoring, and maintenance.",
          img: "/Img/host-server.png",
        },
      ],
    },
    features: {
      title: "Why Choose Peltown Studio?",
      desc: "We understand both business communication and software infrastructure, delivering secure, scalable email setups.",
      list: [
        {
          title: "Technical Expertise",
          desc: "Unlike traditional IT support providers, we understand both business communication workflows and deep software infrastructure.",
          img: "/Img/seo-market.png",
        },
        {
          title: "Security First",
          desc: "Every email setup includes security best practices, cryptographic headers, and routing rules to protect your business.",
          img: "/Img/web-dev.png",
        },
        {
          title: "Complete Setup & Support",
          desc: "From registration and DNS configuration to mail migration and ongoing server maintenance, we manage the entire process.",
          img: "/Img/app-dev.png",
        },
        {
          title: "Scalable Solutions",
          desc: "Whether you need 5 email accounts or 500, we design systems and cloud suites that grow seamlessly with your business.",
          img: "/Img/crm-sol.png",
        },
        {
          title: "Integrated Business Solutions",
          desc: "We integrate your email systems directly with CRM software, ERP systems, corporate websites, mobile apps, and helpdesks.",
          img: "/Img/host-server.png",
        },
      ],
    },
    ...
    costTable: {
      title: "Email Solutions Packages",
      ...
      rows: [
        {
          pkg: "Starter Business Email",
          for: "Small Teams",
          cost: "₹5,000 – ₹12,000",
          del: "Domain Email Setup, Up to 10 Mailboxes, DNS Configuration, Device Configuration",
          color: "text-black",
        },
        {
          pkg: "Google Workspace Setup",
          for: "Cloud Collaboration",
          cost: "₹8,000 – ₹25,000",
          del: "Workspace Configuration, User Setup, Security Configuration, Team Collaboration Setup (license extra)",
          color: "text-[#BFCA16]",
        },
        {
          pkg: "Microsoft 365 Setup",
          for: "Enterprise Workflows",
          cost: "₹10,000 – ₹30,000",
          del: "Microsoft 365 Configuration, Outlook Setup, Teams Configuration, Security Setup (license extra)",
          color: "text-black",
        },
        {
          pkg: "Email Migration Project",
          for: "Transitioning Providers",
          cost: "₹15,000 – ₹75,000",
          del: "Data Migration, User Migration, Testing, Post-Migration Support",
          color: "text-[#BFCA16]",
        },
        {
          pkg: "Enterprise Email Infrastructure",
          for: "Large Organizations",
          cost: "₹50,000 – ₹2,00,000+",
          del: "Custom Architecture, Security Configuration, Multi-Department Setup, Automation Integration",
          color: "text-black",
        },
        {
          pkg: "Email Maintenance & Support",
          for: "Continuous Support",
          cost: "₹3,000 – ₹20,000 / month",
          del: "Monitoring, Troubleshooting, Security Checks, User Support",
          color: "text-[#BFCA16]",
        },
      ],
    },
      ...
      steps: [
        {
          ...
          desc: "Understand your business communication requirements, volume expectations, and team structure.",
        },
        {
          num: "02",
          title: "Solution Planning",
          desc: "Recommending the most suitable, cost-effective email platform and storage configuration.",
        },
        {
          num: "03",
          title: "Setup & Configuration",
          desc: "Configuring domains, user accounts, aliases, access rules, and security settings.",
        },
        {
          num: "04",
          title: "Migration (If Required)",
          desc: "Safely transferring historical emails, contacts, calendars, and folders with zero data loss.",
        },
        {
          num: "05",
          title: "Testing & Deployment",
          desc: "Verifying MX routing, email delivery speeds, spam threshold scores, and security key syncs.",
        },
        {
          num: "06",
          title: "Ongoing Support",
          desc: "Continuous service monitoring, mailbox additions, spam troubleshooting, and system optimization.",
        },
      ],
    },
  },
