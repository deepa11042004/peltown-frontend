...
function ProductPage() {
  const whyChooseUsData = PRODUCTS_WHY_CHOOSE_US_CONTENT["ecommerce-suite"];
  const industriesData = PRODUCTS_INDUSTRIES_SERVE_CONTENT["ecommerce-suite"];
  const pricingData = PRODUCTS_PRICING_CONTENT["ecommerce-suite"];
  const introData = PRODUCTS_INTRO_CONTENT["ecommerce-suite"];

  return (
    <div className="bg-white">
      {/* Hero Section */}
      <ProductHero hero={PRODUCTS_HERO_CONTENT["ecommerce-suite"]} />
      ...
      {/* Detail Section */}
      <DetailSec detail={PRODUCTS_DETAIL_CONTENT["ecommerce-suite"]} />

      {/* Featured Section */}
      <FeaturedSec featured={PRODUCTS_FEATURED_CONTENT["ecommerce-suite"]} />
