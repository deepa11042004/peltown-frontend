...
function ProductPage() {
  const whyChooseUsData = PRODUCTS_WHY_CHOOSE_US_CONTENT["hrms-payroll"];
  const industriesData = PRODUCTS_INDUSTRIES_SERVE_CONTENT["hrms-payroll"];
  const pricingData = PRODUCTS_PRICING_CONTENT["hrms-payroll"];
  const introData = PRODUCTS_INTRO_CONTENT["hrms-payroll"];
