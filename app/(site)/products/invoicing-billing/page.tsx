...
function ProductPage() {
  const whyChooseUsData = PRODUCTS_WHY_CHOOSE_US_CONTENT["invoicing-billing"];
  const industriesData = PRODUCTS_INDUSTRIES_SERVE_CONTENT["invoicing-billing"];
  const pricingData = PRODUCTS_PRICING_CONTENT["invoicing-billing"];
  const introData = PRODUCTS_INTRO_CONTENT["invoicing-billing"];

  return (
    <div className="bg-white">
      {/* Hero Section */}
      <ProductHero hero={PRODUCTS_HERO_CONTENT["invoicing-billing"]} />
      ...
      {/* Detail Section */}
      <DetailSec detail={PRODUCTS_DETAIL_CONTENT["invoicing-billing"]} />

      {/* Featured Section */}
      <FeaturedSec featured={PRODUCTS_FEATURED_CONTENT["invoicing-billing"]} />
      ...
      {/* FAQ Section */}
      <FAQSec tag="Invoicing & Billing FAQs" />
    </div>
  );
}
