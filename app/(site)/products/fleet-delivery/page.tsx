...
function ProductPage() {
  const whyChooseUsData = PRODUCTS_WHY_CHOOSE_US_CONTENT["fleet-delivery"];
  const industriesData = PRODUCTS_INDUSTRIES_SERVE_CONTENT["fleet-delivery"];
  const pricingData = PRODUCTS_PRICING_CONTENT["fleet-delivery"];
  const introData = PRODUCTS_INTRO_CONTENT["fleet-delivery"];
  ...
  return (
    <div className="bg-white">
      ...
      {/* FAQ Section */}
      <FAQSec tag="Fleet Delivery FAQs" />
    </div>
  );
}
