...
function ProductPage() {
  const whyChooseUsData = PRODUCTS_WHY_CHOOSE_US_CONTENT["learning-management"];
  const industriesData = PRODUCTS_INDUSTRIES_SERVE_CONTENT["learning-management"];
  const pricingData = PRODUCTS_PRICING_CONTENT["learning-management"];
  const introData = PRODUCTS_INTRO_CONTENT["learning-management"];
