...
function ProductPage() {
  const whyChooseUsData = PRODUCTS_WHY_CHOOSE_US_CONTENT["omnichannel-crm"];
  const industriesData = PRODUCTS_INDUSTRIES_SERVE_CONTENT["omnichannel-crm"];
  const pricingData = PRODUCTS_PRICING_CONTENT["omnichannel-crm"];
  const introData = PRODUCTS_INTRO_CONTENT["omnichannel-crm"];
