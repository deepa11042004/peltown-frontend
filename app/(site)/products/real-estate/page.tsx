...
function ProductPage() {
  const whyChooseUsData = PRODUCTS_WHY_CHOOSE_US_CONTENT["real-estate"];
  const industriesData = PRODUCTS_INDUSTRIES_SERVE_CONTENT["real-estate"];
  const pricingData = PRODUCTS_PRICING_CONTENT["real-estate"];
  const introData = PRODUCTS_INTRO_CONTENT["real-estate"];
