...
function ProductPage() {
  const whyChooseUsData = PRODUCTS_WHY_CHOOSE_US_CONTENT["cloud-erp"];
  const industriesData = PRODUCTS_INDUSTRIES_SERVE_CONTENT["cloud-erp"];
  const pricingData = PRODUCTS_PRICING_CONTENT["cloud-erp"];
  const introData = PRODUCTS_INTRO_CONTENT["cloud-erp"];
