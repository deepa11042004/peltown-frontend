...
function ProductPage() {
  const whyChooseUsData = PRODUCTS_WHY_CHOOSE_US_CONTENT["quick-commerce"];
  const industriesData = PRODUCTS_INDUSTRIES_SERVE_CONTENT["quick-commerce"];
  const pricingData = PRODUCTS_PRICING_CONTENT["quick-commerce"];
  const introData = PRODUCTS_INTRO_CONTENT["quick-commerce"];
  ...
  return (
    <div className="bg-white">
      ...
      {/* FAQ Section */}
      <FAQSec tag="Quick Commerce FAQs" />
    </div>
  );
}
