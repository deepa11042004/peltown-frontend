...
function ProductPage() {
  const whyChooseUsData = PRODUCTS_WHY_CHOOSE_US_CONTENT["email-automation"];
  const industriesData = PRODUCTS_INDUSTRIES_SERVE_CONTENT["email-automation"];
  const pricingData = PRODUCTS_PRICING_CONTENT["email-automation"];
  const introData = PRODUCTS_INTRO_CONTENT["email-automation"];

  return (
    <div className="bg-white">
      {/* Hero Section */}
      <ProductHero hero={PRODUCTS_HERO_CONTENT["email-automation"]} />
      ...
      {/* Detail Section */}
      <DetailSec detail={PRODUCTS_DETAIL_CONTENT["email-automation"]} />

      {/* Featured Section */}
      <FeaturedSec featured={PRODUCTS_FEATURED_CONTENT["email-automation"]} />
      ...
      {/* FAQ Section */}
      <FAQSec tag="Email Solutions FAQs" />
    </div>
  );
}
