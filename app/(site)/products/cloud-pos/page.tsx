...
function ProductPage() {
  const whyChooseUsData = PRODUCTS_WHY_CHOOSE_US_CONTENT["cloud-pos"];
  const industriesData = PRODUCTS_INDUSTRIES_SERVE_CONTENT["cloud-pos"];
  const pricingData = PRODUCTS_PRICING_CONTENT["cloud-pos"];
  const introData = PRODUCTS_INTRO_CONTENT["cloud-pos"];

  return (
    <div className="bg-white">
      {/* Hero Section */}
      <ProductHero hero={PRODUCTS_HERO_CONTENT["cloud-pos"]} />
      ...
      {/* Detail Section */}
      <DetailSec detail={PRODUCTS_DETAIL_CONTENT["cloud-pos"]} />

      {/* Featured Section */}
      <FeaturedSec featured={PRODUCTS_FEATURED_CONTENT["cloud-pos"]} />
