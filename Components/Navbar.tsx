...
export default function Navbar() {
  ...
  return (
    <header
      className="fixed top-10 left-4 right-4 z-50 font-sans pointer-events-none flex justify-center"
    ...
    >
      <div
        className={`pointer-events-auto w-full max-w-7xl bg-white/95 backdrop-blur-md border border-zinc-200/80 shadow-lg transition-all duration-300 ease-in-out relative overflow-hidden ${
          activeMenu ? "rounded-4xl" : "rounded-4xl"
        }`}
      >
        <div className="px-10 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6 shrink-0">
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/login"
                className="text-sm font-bold text-zinc-700 hover:text-black px-5 py-2 rounded-full border border-zinc-200 hover:border-zinc-300 transition-all"
              >
                Login
              </Link>
              <Link
                href="/about/contact"
                className="text-sm font-bold bg-black text-white px-5 py-2 rounded-full hover:bg-zinc-800 transition-all shadow-sm"
              >
                Contact Us
              </Link>
            </div>
