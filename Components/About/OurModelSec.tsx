          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative flex flex-col justify-between rounded-3xl overflow-hidden p-6 md:p-8 min-h-72.5 group cursor-pointer bg-cardBgColor border border-cardBorderColor"
                whileHover="hover"
              >
